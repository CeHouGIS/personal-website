...
![设置机器人](public/blogs/images/docker-openclaw/oauth-setting.jpg)

在OAuth2中，对**机器人权限**进行配置
![设置机器人](public/blogs/images/docker-openclaw/oauth-bot-auth.jpg)

在OAuth2中，对**OAuth2 URL生成器**进行配置
![设置机器人](public/blogs/images/docker-openclaw/oauth-url.jpg)
