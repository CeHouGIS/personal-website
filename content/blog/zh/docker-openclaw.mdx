...
## 5. [Discord](https://discord.com/)机器人配置
本文作者主要参照[OpenClaw官方提供的Discord安装教程](https://docs.openclaw.ai/channels/discord)实现的[Discord](https://discord.com/)机器人的安装。

首先，进入[Discord Developer Portal](https://discord.com/developers/applications/)中，添加新的APP

![点击界面右上角创建新app](blogs/docker-openclaw/images/docker-openclaw/get-new-bot.jpg)

然后，给这个项目起一个名字
![为该项目命名](blogs/docker-openclaw/images/docker-openclaw/project-name.jpg)

之后，点击左侧**机器人**页面，设置机器人的授权意图如图所示：
![设置机器人](blogs/docker-openclaw/images/docker-openclaw/bot-setting.jpg)

然后，点击左侧**OAuth2**界面，进行进一步配置
![OAuth2设置界面](blogs/docker-openclaw/images/docker-openclaw/oauth-setting.jpg)

在OAuth2中，对**机器人权限**进行配置
![在OAuth2中设置机器人权限](blogs/docker-openclaw/images/docker-openclaw/oauth-bot-auth.jpg)

在OAuth2中，对**OAuth2 URL生成器**进行配置
![在OAuth2中设置OAuth2 URL生成器](blogs/docker-openclaw/images/docker-openclaw/oauth-url.jpg)

完成以上配置，将下方生成的链接复制到浏览器中
![机器人链接](blogs/docker-openclaw/images/docker-openclaw/oauth-url.jpg)

最后，让机器人加入你的Discord服务器中
![让机器人加入服务器](blogs/docker-openclaw/images/docker-openclaw/robot-connection.jpg)

![测试图](blogs/docker-openclaw/bot-setting.png)
...
![OpenClaw和Discord配对](blogs/docker-openclaw/images/docker-openclaw/pairing.png)
